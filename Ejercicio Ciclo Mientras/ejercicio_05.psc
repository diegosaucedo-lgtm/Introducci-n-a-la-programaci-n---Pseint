...
//	intervalo.
	...
	Definir n, n1, n2, cont Como Entero
	
	Escribir "Ingresa el límite máximo de enteros positivo: "
	Leer n1
	
	Escribir "Ingresa el límite mínimo de enteros positivo: "
	Leer n2
	
	Escribir "Ingresa un número entre los dos intervalos: "
	Leer n 
